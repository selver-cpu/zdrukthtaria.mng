...
class ProjektGatiPerMontimNotification extends Notification
{
    use Queueable;
     ...
     */
    public function __construct($projekt, $montuesi)
    {
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Projekt i ri gati për montim')
                    ->greeting('Përshëndetje ' . $this->montuesi->emri . '!')
                    ->line('Projekti "' . $this->projekt->emri_projektit . '" është gati për montim.')
                    ...
                    ->line('Ju lutemi planifikoni montimin sa më shpejt të jetë e mundur.');
    }
    ...
    {
        return [
            'mesazhi' => 'Projekti "' . $this->projekt->emri_projektit . '" është gati për montim.',
