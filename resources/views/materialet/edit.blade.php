<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Modifiko Materialin') }}: {{ $materialet->emri }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('materialet.update', $materialet) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="emri" class="block mt-1 w-full" type="text" name="emri" :value="old('emri', $materialet->emri)" required autofocus />
