                    ...
                    <form method="POST" action="{{ route('materialet.store') }}">
                        ...
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="sasia_stokut" class="block mt-1 w-full" type="number" step="0.01" name="sasia_stokut" :value="old('sasia_stokut')" />
                                <x-input-error :messages="$errors->get('sasia_stokut')" class="mt-2" />
                            </div>

                            <div>
                                <x-input-label for="sasia_minimale" :value="__('Sasia Minimale (Alert)')" />
                                <x-text-input id="sasia_minimale" class="block mt-1 w-full" type="number" step="0.01" name="sasia_minimale" :value="old('sasia_minimale')" />
                        ...
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="cmimi_per_njesi" class="block mt-1 w-full" type="number" step="0.01" name="cmimi_per_njesi" :value="old('cmimi_per_njesi')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="lokacioni" class="block mt-1 w-full" type="text" name="lokacioni" :value="old('lokacioni')" />
