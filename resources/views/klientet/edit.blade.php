<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Modifiko Klientin') }}: {{ $klientet->emri }}
        </h2>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('klientet.update', $klientet) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="emri" class="block mt-1 w-full" type="text" name="emri" :value="old('emri', $klientet->emri)" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $klientet->email)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="telefon" class="block mt-1 w-full" type="text" name="telefon" :value="old('telefon', $klientet->telefon)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="adresa_faturimit" class="block mt-1 w-full" type="text" name="adresa_faturimit" :value="old('adresa_faturimit', $klientet->adresa_faturimit)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="kodi_postar" class="block mt-1 w-full" type="text" name="kodi_postar" :value="old('kodi_postar', $klientet->kodi_postar)" required />
