                    ...
                    <form method="POST" action="{{ route('klientet.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="emri_klientit" class="block mt-1 w-full" type="text" name="emri_klientit" :value="old('emri_klientit')" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input id="email_kontakt" class="block mt-1 w-full" type="email" name="email_kontakt" :value="old('email_kontakt')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="telefon_kontakt" class="block mt-1 w-full" type="text" name="telefon_kontakt" :value="old('telefon_kontakt')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="adresa_faktura" class="block mt-1 w-full" type="text" name="adresa_faktura" :value="old('adresa_faktura')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="kodi_postal" class="block mt-1 w-full" type="text" name="kodi_postal" :value="old('kodi_postal')" required />
