        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('statuset.store') }}">
                        @csrf

                        <!-- Emri i Statusit -->
                        <div>
                            <x-input-label for="emri_statusit" :value="__('Emri i Statusit')" />
                            <x-text-input id="emri_statusit" class="block mt-1 w-full" type="text" name="emri_statusit" :value="old('emri_statusit')" required autofocus />
