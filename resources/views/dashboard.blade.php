...
<div class="py-6">
    ...
    <div id="virtual-keyboard" class="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-300 p-2 hidden z-50">
        <div class="flex flex-wrap justify-center">
            <div class="keyboard-row flex flex-wrap justify-center w-full mb-2">
                ...
                @endforeach
                <button class="keyboard-key bg-red-200 hover:bg-red-300 text-red-800 font-semibold py-3 px-4 rounded-lg m-1 min-w-[80px] text-xl">⌫</button>
            </div>
            <div class="keyboard-row flex flex-wrap justify-center w-full mb-2">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const inputFields = document.querySelectorAll('input[type="text"], input[type="search"], input[type="email"], textarea');
